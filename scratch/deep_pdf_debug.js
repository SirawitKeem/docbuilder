...
async function testPdfOptions() {
  ...
  // Test Option 1: Standard A4
  const pdf1 = await page.pdf({
    format: "A4",
    printBackground: true,
    margin: { top: "0", bottom: "0", left: "0", right: "0" },
  });
  console.log("PDF Option 1 Size:", pdf1.length);

  // Test Option 2: preferCSSPageSize
  ...
  console.log("PDF Option 2 Size:", pdf2.length);

  await browser.close();
}

testPdfOptions().catch(console.error);
