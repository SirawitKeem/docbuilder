export const ndaTemplate = {
  ...
  fields: [
    ...
    { id: "receiving_party_name", label: "ชื่อบริษัท/นิติบุคคล (ผู้รับข้อมูล)", type: "text", page: 1, placeholder: "บริษัท ตัวอย่าง จำกัด", required: true },
    { id: "receiving_party_address", label: "ที่อยู่สำนักงาน (ผู้รับข้อมูล)", type: "textarea", page: 1, placeholder: "เลขที่ ... แขวง/ตำบล ... เขต/อำเภอ ... จังหวัด ... รหัสไปรษณีย์ ...", required: true },
    { id: "receiving_signatory_name", label: "ชื่อผู้ลงนาม (ผู้รับข้อมูล)", type: "text", page: 4, placeholder: "ชื่อ-นามสกุล", required: true },
    { id: "receiving_signatory_position", label: "ตำแหน่ง", type: "text", page: 4, placeholder: "เช่น กรรมการผู้จัดการ", required: true },
  ],
};
