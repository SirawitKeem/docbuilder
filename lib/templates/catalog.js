...
export const SYSTEM_DEFAULT_TEMPLATES = [
  ...
  {
    id: "tmpl-notification-standard",
    categoryId: "notification",
    version: 1,
    name: "หนังสือแจ้งเปลี่ยนแปลงที่ตั้งสำนักงานใหญ่",
    englishName: "Notice of Head Office Relocation",
    description: "หนังสือแจ้งการเปลี่ยนแปลงที่อยู่และสถานที่ตั้งสำนักงานใหญ่ทางการ (ไทย-อังกฤษ)",
    icon: "Megaphone",
    badge: "มาตรฐาน",
    pageCount: "1 หน้า A4",
    status: "published",
    ...
    blocks: [
      {
        ...
        settings: {
          hasLogo: true,
          logoUrl: "/quotation.png",
          companyName: "บริษัท เครสท์ เซนโด จำกัด",
          companyNameEn: "CREST ZENDO CO., LTD.",
          taxId: "0105558073755",
      ...
      },
      {
        ...
        title: "หัวเรื่อง",
        settings: {
          titleText: "หนังสือแจ้งเปลี่ยนแปลงที่ตั้งสำนักงานใหญ่",
          subtitleText: "NOTICE OF HEAD OFFICE RELOCATION",
          align: "center",
        },
      },
      {
        ...
        settings: {
          billToTitle: "เรียน:",
          billToCompany: "ท่านคู่ค้า ลูกค้า และพันธมิตรทางธุรกิจทุกท่าน",
          attnName: "ผู้มีอุปการคุณทุกท่าน",
          subject: "แจ้งเปลี่ยนแปลงสถานที่ตั้งสำนักงานใหญ่แห่งใหม่",
          quotationNo: "TRAC-2609001",
          date: "01 กันยายน 2569",
          validity: "มีผล 16 กันยายน 2569",
          amName: "ฝ่ายบริหารจัดการทั่วไป",
        },
      },
      {
        id: "b_text",
        type: "text_block",
        title: "ข้อความหนังสือแจ้ง",
        settings: {
          content: "บริษัท เครสท์ เซนโด จำกัด ขอเรียนแจ้งให้ท่านทราบว่า บริษัทฯ ได้ดำเนินการย้ายสถานที่ตั้งสำนักงานใหญ่แห่งใหม่ เพื่อรองรับการขยายตัวทางธุรกิจและการให้บริการที่มีประสิทธิภาพยิ่งขึ้น โดยมีผลบังคับใช้ตั้งแต่วันที่ 16 กันยายน 2569 เป็นต้นไป",
        },
      },
      {
        id: "b_terms",
        type: "terms",
        title: "เปรียบเทียบที่อยู่เดิมและใหม่",
        settings: {
          heading: "รายละเอียดสถานที่ตั้งสำนักงานใหญ่:",
          bullets: [
            "ที่อยู่เดิม: 45 ซอยโกสุมรวมใจ 37 แขวงดอนเมือง เขตดอนเมือง กรุงเทพมหานคร 10210",
            "ที่อยู่ใหม่ (มีผล 16 ก.ย. 2569): 8/40 The Connect 37, ซอยช่างอากาศอุทิศ 10 แยก 1-2 แขวงดอนเมือง เขตดอนเมือง กรุงเทพมหานคร 10210",
            "หมายเลขโทรศัพท์และช่องทางการติดต่อทางอิเล็กทรอนิกส์ยังคงใช้งานได้ตามปกติ",
          ],
        },
      },
      {
        ...
        settings: {
          slots: [
            { id: "s1", name: "นายศรายุทธ โกสิยารักษ์", role: "กรรมการผู้จัดการ / CEO" },
          ],
        },
      },
    ],
