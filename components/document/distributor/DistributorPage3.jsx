export default function DistributorPage3() {
  return (
    <div className="text-[12px] leading-[1.85] text-gray-900 font-normal">
      ...
      <ul className="list-disc pl-10 space-y-2 mb-6 text-justify font-normal">
        <li>
        ...
        <li>
          หาก &ldquo;ตัวแทนจำหน่ายต่อ&rdquo; ชำระเงินล่าช้ากว่ากำหนด ต้องเสียดอกเบี้ยปรับในอัตรา ร้อยละ 1.5 (หนึ่งจุดห้า) ต่อเดือนของยอดเงินที่ค้างชำระ และ &ldquo;ตัวแทนจำหน่ายต่อ&rdquo; มีสิทธิชะลอการออกสิทธิ์การใช้งานใหม่จนกว่าจะได้รับชำระหนี้ค้างชำระครบถ้วน
        </li>
      ...
      <ul className="list-none space-y-2 mb-2 text-justify font-normal">
        <li className="pl-4">
      ...
      <ul className="list-disc pl-10 space-y-2 mb-4 text-justify font-normal">
        <li>
      ...
      <p className="mb-6 pl-4 text-justify font-normal">
      ...
      <ul className="list-none space-y-2 mb-6 text-justify font-normal">
        ...
        <li className="pl-4">
          <span className="font-bold">7.2. การจำกัดความรับผิด (Limitation of Liability):</span>{" "}
          ความรับผิดชอบสูงสุดทางการเงินของคู่สัญญาฝ่ายหนึ่งฝ่ายใดต่อความเสียหายใดๆ ที่เกิดขึ้นภายใต้สัญญานี้ (ไม่ว่าจะเป็นทางตรงหรือทางอ้อม) จะถูกจำกัดไว้ไม่เกินยอดเงินรวมที่ &ldquo;ตัวแทนจำหน่ายต่อ&rdquo; ได้ชำระให้แก่ &ldquo;ผู้จัดจำหน่ายหลัก&rdquo; ที่ผ่านมาก่อนเกิดเหตุ ทั้งนี้ คู่สัญญาจะไม่รับผิดชอบต่อความเสียหายเกี่ยวกับกำไรทางธุรกิจที่สูญเสียไปหรือความเสียหายเนื่องมาจากการสะดุดหยุดลงของธุรกิจ (Consequential Damages)
        </li>
      </ul>

      {/* Section 8 */}
      <h2 className="font-bold mb-2">8. การรับประกันสินค้า (Warranty)</h2>
      <p className="text-justify pl-4 font-normal">
