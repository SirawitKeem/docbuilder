  ...
  return (
    <div className="text-[13px] leading-[1.9] text-gray-900 font-normal">
      ...
      <p className="mb-4 mt-1">
        ...
        <span className="font-semibold">&ldquo;ผู้รับข้อมูล&rdquo; (Receiving Party)</span>{" "}
        อีกฝ่ายหนึ่ง
      </p>
      ...
      <ul className="list-disc pl-12 space-y-1.5 text-justify">
        <li>
          <span className="font-medium">ข้อมูลด้านเทคนิคและซอฟต์แวร์:</span> ซอร์ซโค้ด
        ...
        <li>
          <span className="font-medium">ข้อมูลทางการค้าและธุรกิจ:</span>{" "}
        ...
        <li>
          <span className="font-medium">ข้อมูลส่วนบุคคล (Personal Data):</span>{" "}
        ...
        <li>
          <span className="font-medium">ความคิดสร้างสรรค์และทรัพย์สินทางปัญญา:</span>{" "}
