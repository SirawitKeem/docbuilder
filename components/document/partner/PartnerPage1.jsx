...
export default function PartnerPage1() {
  ...
  return (
    <div className="text-[9.5pt] leading-[1.75] text-gray-900 font-normal">
      <h1 className="text-center text-[14px] font-bold mb-0.5">
        สัญญาแต่งตั้งพันธมิตรตัวแทนจำหน่าย
      </h1>
      <p className="text-center font-normal text-[9.5pt] mb-5">(Partner Agreement)</p>
      ...
      <h2 className="font-bold mb-1 text-[9.5pt]">ข้อ 1. นิยามศัพท์ (Definitions)</h2>
      <p className="mb-1">
      ...
      <h2 className="font-bold mb-1 text-[9.5pt]">ข้อ 2. ขอบเขตการแต่งตั้งและอาณาเขต (Scope of Appointment & Territory)</h2>
      <p className="mb-0.5 pl-4 font-bold">2.1 การแต่งตั้งและบทบาทของ &ldquo;ผู้จัดจำหน่ายหลัก&rdquo;:</p>
      <ul className="list-disc pl-10 space-y-1 mb-1.5">
        <li>
