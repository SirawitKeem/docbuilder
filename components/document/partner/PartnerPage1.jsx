...
export default function PartnerPage1() {
  ...
  return (
    <div className="document-body pt-2 text-[12px] leading-snug text-left">
      <h1 className="text-center" style={{ textAlign: "center" }}>สัญญาแต่งตั้งพันธมิตรตัวแทนจำหน่าย</h1>
      <p className="subtitle text-center text-[15px] mb-1.5" style={{ textAlign: "center" }}>(Partner Agreement)</p>
      ...
      <h2 className="mt-1 mb-0.5 text-left">ข้อ 1. นิยามศัพท์ (Definitions)</h2>
      <p className="mb-0.5 text-left">
