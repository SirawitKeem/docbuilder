    ...
    <div className="text-[13px] leading-[1.9] text-gray-900 font-normal">
      ...
      <ul className="list-disc pl-12 space-y-2 mb-4 text-justify">
        ...
        <li>
          ...
          หรือข้อมูลทางการค้าใด ๆ ที่ได้รับจาก &ldquo;ตัวแทนจำหน่าย&rdquo; ไปใช้ประโยชน์เพื่อตนเองหรือ
          บุคคลภายนอก หรือนำไปใช้ในลักษณะที่ส่งผลกระทบ ก่อให้เกิดความเสียหาย หรือทำให้
          &ldquo;ตัวแทนจำหน่าย&rdquo; เสียประโยชน์ทางธุรกิจ ไม่ว่าโดยทางตรงหรือทางอ้อม
        </li>
      </ul>
      ...
      <ul className="list-disc pl-12 space-y-2 mb-6 text-justify">
        ...
        <li>
          ...
          จาก &ldquo;ผู้จัดจำหน่ายหลัก&rdquo;
        </li>
      </ul>
