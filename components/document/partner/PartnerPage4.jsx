export default function PartnerPage4() {
  return (
    <div className="document-body pt-2 text-[12px] leading-snug">
      <h2 className="mt-1 mb-1">ข้อ 7. การจัดการทรัพย์สินทางปัญญาและการจำกัดความรับผิด (Intellectual Property & Limitation of Liability)</h2>
      <div className="space-y-1 pl-3 mb-2 text-[11.5px]">
        <p>
      ...
      <h2 className="mt-2 mb-1">ข้อ 8. การรับประกัน (Warranty)</h2>
      <div className="space-y-1 pl-3 mb-2 text-[11.5px]">
        <p>
        ...
        <div>
          ...
          <ul className="list-disc pl-5 space-y-0.5 font-normal text-[11px]">
            <li>
      ...
      <h2 className="mt-2 mb-1">ข้อ 9. การรักษาความลับข้อมูลและการคุ้มครองข้อมูลส่วนบุคคล (Confidentiality & Data Protection)</h2>
      <div className="pl-3 space-y-1 text-[11.5px]">
        <div>
